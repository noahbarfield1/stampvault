...
export const VERIFIED_STAMPS: VerifiedStampMock[] = [
  ...
  },
  {
    ...
    referenceImageUrl: '/harrison-9c-reference.jpg',
    estimatedValue: 4.50,
  ...
  {
    keywords: ['washington', '804', 'stamp 2'],
    detectedDescription: 'US 1938 1¢ Presidential Series George Washington stamp (Scott #804)',
    id: 'stamp-washington-1c',
    country: 'United States',
    year: 1938,
    denomination: '1¢',
    scottNumber: '804',
    michelNumber: '417',
    description: 'US 1938 1¢ Presidential Series George Washington stamp. Profile of George Washington based on a bust by Jean-Antoine Houdon.',
    condition: 'used',
    rarity: 'common',
    color: 'green',
    perforation: '11 x 10.5',
    ...
    series: 'Presidential Series (Prexies)',
    grade: 80,
    notes: 'Used copy of the 1¢ George Washington Prexie.',
    tags: ['Presidents', 'Prexies'],
    referenceImageUrl: '/washington-1c-reference.jpg',
    estimatedValue: 0.15,
    priceRange: { min: 0.05, max: 1.00 },
    hipValue: 0.20,
    sources: [
      {
        platform: 'ebay',
        price: 0.15,
        currency: 'USD',
        url: 'https://www.ebay.com/sch/i.html?_nkw=us+scott+804+used',
        title: 'US Scott 804 Used Prexie 1c Washington',
        condition: 'used',
        soldDate: new Date().toISOString(),
        listingType: 'sold',
        fetchedAt: new Date().toISOString(),
    ...
    sourceBreakdown: {
      hipstamp: { avg: 0.20, count: 1 },
      ebay: { avg: 0.15, min: 0.05, max: 0.30, count: 10 },
      delcampe: null,
      stampworld: null,
    },
    priceHistory: [
      { date: '2026-01-01', value: 0.12, sources: 2 },
      { date: '2026-06-21', value: 0.15, sources: 2 },
    ]
  },
  {
    keywords: ['van buren', '813', 'stamp 3'],
    detectedDescription: 'US 1938 8¢ Presidential Series Martin Van Buren stamp (Scott #813)',
    id: 'stamp-vanburen-8c',
    country: 'United States',
    year: 1938,
    denomination: '8¢',
    scottNumber: '813',
    michelNumber: '426',
    description: 'US 1938 8¢ Presidential Series Martin Van Buren stamp.',
    condition: 'used',
    rarity: 'common',
    color: 'olive green',
    perforation: '11 x 10.5',
    ...
    series: 'Presidential Series (Prexies)',
    grade: 80,
    notes: 'Used copy of the 8¢ Martin Van Buren Prexie.',
    tags: ['Presidents', 'Prexies'],
    referenceImageUrl: '/vanburen-8c-reference.jpg',
    estimatedValue: 0.35,
    priceRange: { min: 0.10, max: 2.00 },
    hipValue: 0.40,
    sources: [
      {
        platform: 'ebay',
        price: 0.35,
        currency: 'USD',
        url: 'https://www.ebay.com/sch/i.html?_nkw=us+scott+813+used',
        title: 'US Scott 813 Used Prexie 8c Van Buren',
        condition: 'used',
        soldDate: new Date().toISOString(),
        listingType: 'sold',
        fetchedAt: new Date().toISOString(),
    ...
    sourceBreakdown: {
      hipstamp: { avg: 0.40, count: 1 },
      ebay: { avg: 0.35, min: 0.10, max: 0.60, count: 5 },
      delcampe: null,
      stampworld: null,
    },
    priceHistory: [
      { date: '2026-01-01', value: 0.30, sources: 2 },
      { date: '2026-06-21', value: 0.35, sources: 2 },
    ]
  }
];
